...
/* Private defines -----------------------------------------------------------*/
#define M203_DATA_IN2_Pin GPIO_PIN_2
#define M203_DATA_IN2_GPIO_Port GPIOE
#define M203_DATA_IN3_Pin GPIO_PIN_3
#define M203_DATA_IN3_GPIO_Port GPIOE
#define M203_DATA_IN4_Pin GPIO_PIN_4
#define M203_DATA_IN4_GPIO_Port GPIOE
#define M203_DATA_IN5_Pin GPIO_PIN_5
#define M203_DATA_IN5_GPIO_Port GPIOE
#define M203_DATA_IN6_Pin GPIO_PIN_6
#define M203_DATA_IN6_GPIO_Port GPIOE
#define EN_1_1V_Pin GPIO_PIN_13
#define EN_1_1V_GPIO_Port GPIOC
...
#define GWL2_EN_Pin GPIO_PIN_10
#define GWL2_EN_GPIO_Port GPIOF
#define NRST_Pin GPIO_PIN_10
#define NRST_GPIO_Port GPIOG
#define GWL2_A0_Pin GPIO_PIN_0
#define GWL2_A0_GPIO_Port GPIOC
#define GWL2_A1_Pin GPIO_PIN_1
#define GWL2_A1_GPIO_Port GPIOC
#define GSL3_EN_Pin GPIO_PIN_2
#define GSL3_EN_GPIO_Port GPIOC
#define GSL3_A0_Pin GPIO_PIN_3
#define GSL3_A0_GPIO_Port GPIOC
#define GSL3_A1_Pin GPIO_PIN_2
#define GSL3_A1_GPIO_Port GPIOF
...
#define M203_DATA_IN7_Pin GPIO_PIN_7
#define M203_DATA_IN7_GPIO_Port GPIOE
#define M203_RSTN_Pin GPIO_PIN_8
#define M203_RSTN_GPIO_Port GPIOE
#define M203_CMD_Pin GPIO_PIN_9
#define M203_CMD_GPIO_Port GPIOE
#define M203_CLK_Pin GPIO_PIN_10
#define M203_CLK_GPIO_Port GPIOE
#define DAC_CS3_Pin GPIO_PIN_11
#define DAC_CS3_GPIO_Port GPIOE
#define DAC_CS2_Pin GPIO_PIN_12
#define DAC_CS2_GPIO_Port GPIOE
...
#define GSL3_ADC_X2_SEL_Pin GPIO_PIN_3
#define GSL3_ADC_X2_SEL_GPIO_Port GPIOG
...
#define GSL2_ADC_X1_SEL_Pin GPIO_PIN_9
#define GSL2_ADC_X1_SEL_GPIO_Port GPIOA
...
#define GSL2_A1_Pin GPIO_PIN_6
#define GSL2_A1_GPIO_Port GPIOF
#define GSL2_A0_Pin GPIO_PIN_5
#define GSL2_A0_GPIO_Port GPIOG
#define GSL2_EN_Pin GPIO_PIN_6
#define GSL2_EN_GPIO_Port GPIOG
#define GBL3_A1_Pin GPIO_PIN_7
#define GBL3_A1_GPIO_Port GPIOG
#define GBL3_A0_Pin GPIO_PIN_8
#define GBL3_A0_GPIO_Port GPIOG
#define GBL3_EN_Pin GPIO_PIN_9
#define GBL3_EN_GPIO_Port GPIOG
...
#define GBL2_A1_Pin GPIO_PIN_6
#define GBL2_A1_GPIO_Port GPIOB
#define GBL2_A0_Pin GPIO_PIN_7
#define GBL2_A0_GPIO_Port GPIOB
#define GBL2_EN_Pin GPIO_PIN_9
#define GBL2_EN_GPIO_Port GPIOB
#define M203_DATA_IN0_Pin GPIO_PIN_0
#define M203_DATA_IN0_GPIO_Port GPIOE
#define M203_DATA_IN1_Pin GPIO_PIN_1
#define M203_DATA_IN1_GPIO_Port GPIOE
